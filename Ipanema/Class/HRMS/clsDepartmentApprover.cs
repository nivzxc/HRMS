...
namespace HRMS
{
 public class clsDepartmentApprover : IDisposable
 {
  ...
  public string ApproverID { set { _strapproverID = value; } get { return _strapproverID; } }
  ...
  public int Insert()
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "INSERT INTO HR.DepartmentApprover VALUES(@deptcode,@username,@leave,@ut,@ob,@ot,@rfiflag,@approver_id)";
    ...
    cmd.Parameters.Add(new SqlParameter("@approver_id",_strapproverID));
    cn.Open();
  ...
  public int Update()
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "UPDATE HR.DepartmentApprover SET leave=@leave, ut=@ut, ob=@ob, ot=@ot WHERE deptcode=@deptcode AND username=@username";
    cmd.Parameters.Add(new SqlParameter("@deptcode", _strDepartmentCode));
    cmd.Parameters.Add(new SqlParameter("@username", _strUsername));
    cmd.Parameters.Add(new SqlParameter("@leave", _strLeave));
    cmd.Parameters.Add(new SqlParameter("@ut", _strUT));
  ...
  public int Delete()
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "DELETE FROM HR.DepartmentApprover WHERE deptcode='" + _strDepartmentCode + "' AND username='" + _strUsername + "' AND approver_id ='"+ _strapproverID+"'";
    cn.Open();
    intReturn = cmd.ExecuteNonQuery();
   }
   return intReturn;
