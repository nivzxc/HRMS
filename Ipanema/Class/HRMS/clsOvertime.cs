...
namespace HRMS
{
 ...
 public class clsOvertime : IDisposable
 {
  ...
  private int _strMessageAlert;

  public clsOvertime() { }
  public clsOvertime(string pOvertimeCode) { _strOvertimeCode = pOvertimeCode; }
  public int MessageAlert { get { return _strMessageAlert; } set { _strMessageAlert = value; } }
   ...
   using (SqlConnection cn = new SqlConnection(HRMSCore.HrmsConnectionString))
   {
    ...
    string insert_OT_query = "INSERT INTO HR.Overtime (otcode," +
                                      ...
                                      "VALUES (@otcode," +
                                              ...
                                              "@apphstat," +
                                              "@otstat)";
                SqlCommand cmd = new SqlCommand(insert_OT_query, cn);
                ...
                if (_strChargeType == "0"){
                    ...
                    cmd.Parameters.Add(new SqlParameter("@apprname", _strRequestorApproverName));
                    cmd.Parameters.Add(new SqlParameter("@apprdate", _dteRequestorApproverDate));
                    cmd.Parameters.Add(new SqlParameter("@apprrem", _strRequestorApproverRemarks));
                    cmd.Parameters.Add(new SqlParameter("@apprstat", _strRequestorApproverStatus));
                }
                cmd.Parameters.Add(new SqlParameter("@apphname",_strHeadApproverName));
                cmd.Parameters.Add(new SqlParameter("@apphdate",_dteHeadApproverDate));
