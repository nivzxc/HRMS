...
namespace HRMS
{
 public class JobGrade : IDisposable
 {
  ...
  public int Insert()
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "INSERT INTO HR.JobGrade (jgcode,jgdesc,jgorder,dedulate,deduut,payot,plntcnth,plntcntb,createby,createon,modifyby,modifyon) "
                                    + " VALUES (@jgcode,@jgdesc,@jgorder,@dedulate,@deduut,@payot,@plntcnth,@plntcntb,@createby,@createon,@modifyby,@modifyon)";
