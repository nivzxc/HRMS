namespace Ipanema.Forms
{
 partial class frmOffenseList
 {
  ...
  {
   System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmOffenseList));
   ...
   this.dgOffenseList = new System.Windows.Forms.DataGridView();
   ...
   ((System.ComponentModel.ISupportInitialize)(this.dgOffenseList)).BeginInit();
   this.SuspendLayout();
   // 
   // pnlHeader
   // 
   ...
   this.pnlHeader.Size = new System.Drawing.Size(1119, 28);
   ...
   this.tsButtons.Size = new System.Drawing.Size(1119, 29);
   ...
   // pnlBody
   // 
   this.pnlBody.Controls.Add(this.dgOffenseList);
   this.pnlBody.Dock = System.Windows.Forms.DockStyle.Fill;
   this.pnlBody.Location = new System.Drawing.Point(0, 28);
   this.pnlBody.Name = "pnlBody";
   this.pnlBody.Size = new System.Drawing.Size(1119, 620);
   this.pnlBody.TabIndex = 2;
   // 
   // dgOffenseList
   // 
   this.dgOffenseList.AllowUserToAddRows = false;
   this.dgOffenseList.AllowUserToDeleteRows = false;
   this.dgOffenseList.AllowUserToOrderColumns = true;
   dataGridViewCellStyle1.BackColor = System.Drawing.Color.AliceBlue;
   this.dgOffenseList.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
   this.dgOffenseList.BorderStyle = System.Windows.Forms.BorderStyle.None;
   this.dgOffenseList.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
   this.dgOffenseList.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
   this.dgOffenseList.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.colCode,
            this.colName,
            this.colDetails,
            this.colClass,
            ...
            this.colDateEnd,
            this.colEnabled});
   this.dgOffenseList.Cursor = System.Windows.Forms.Cursors.Default;
   this.dgOffenseList.Dock = System.Windows.Forms.DockStyle.Fill;
   this.dgOffenseList.Location = new System.Drawing.Point(0, 0);
   this.dgOffenseList.MultiSelect = false;
   this.dgOffenseList.Name = "dgOffenseList";
   this.dgOffenseList.ReadOnly = true;
   this.dgOffenseList.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
   this.dgOffenseList.RowHeadersWidth = 20;
   this.dgOffenseList.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
   this.dgOffenseList.Size = new System.Drawing.Size(1119, 620);
   this.dgOffenseList.TabIndex = 8;
   this.dgOffenseList.VirtualMode = true;
   this.dgOffenseList.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgOffenseList_CellDoubleClick);
   // 
   // colCode
   // 
   this.colCode.Frozen = true;
   this.colCode.HeaderText = "Offense Code";
   ...
   this.Name = "frmOffenseList";
   this.Text = "Offense Masterlist";
   this.Load += new System.EventHandler(this.frmOffenseList_Load);
   this.pnlHeader.ResumeLayout(false);
   this.pnlHeader.PerformLayout();
   this.tsButtons.ResumeLayout(false);
   this.tsButtons.PerformLayout();
   this.pnlBody.ResumeLayout(false);
   ((System.ComponentModel.ISupportInitialize)(this.dgOffenseList)).EndInit();
  ...
  internal System.Windows.Forms.DataGridView dgOffenseList;
