...
{
 partial class frmResignationReasonList
 {
  /// <summary>
  ...
  {
   System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmResignationReasonList));
   ...
   this.dgResignationReasonList = new System.Windows.Forms.DataGridView();
   this.colResignationReasonCode = new System.Windows.Forms.DataGridViewTextBoxColumn();
   this.colName = new System.Windows.Forms.DataGridViewTextBoxColumn();
   this.colEnabled = new System.Windows.Forms.DataGridViewTextBoxColumn();
   this.pnlHeader.SuspendLayout();
   this.tsButtons.SuspendLayout();
   this.pnlBody.SuspendLayout();
   ((System.ComponentModel.ISupportInitialize)(this.dgResignationReasonList)).BeginInit();
   this.SuspendLayout();
   // 
   // pnlHeader
   // 
   ...
   this.pnlHeader.Size = new System.Drawing.Size(1061, 34);
   ...
   this.tsButtons.Size = new System.Drawing.Size(1061, 29);
   ...
   // pnlBody
   // 
   this.pnlBody.Controls.Add(this.dgResignationReasonList);
   this.pnlBody.Dock = System.Windows.Forms.DockStyle.Fill;
   this.pnlBody.Location = new System.Drawing.Point(0, 34);
   this.pnlBody.Name = "pnlBody";
   this.pnlBody.Size = new System.Drawing.Size(1061, 498);
   this.pnlBody.TabIndex = 1;
   // 
   // dgResignationReasonList
   // 
   this.dgResignationReasonList.AllowUserToAddRows = false;
   this.dgResignationReasonList.AllowUserToDeleteRows = false;
   this.dgResignationReasonList.AllowUserToOrderColumns = true;
   dataGridViewCellStyle1.BackColor = System.Drawing.Color.AliceBlue;
   this.dgResignationReasonList.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
   this.dgResignationReasonList.BorderStyle = System.Windows.Forms.BorderStyle.None;
   this.dgResignationReasonList.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
   this.dgResignationReasonList.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
   this.dgResignationReasonList.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.colResignationReasonCode,
            this.colName,
            this.colEnabled});
   this.dgResignationReasonList.Cursor = System.Windows.Forms.Cursors.Default;
   this.dgResignationReasonList.Dock = System.Windows.Forms.DockStyle.Fill;
   this.dgResignationReasonList.Location = new System.Drawing.Point(0, 0);
   this.dgResignationReasonList.MultiSelect = false;
   this.dgResignationReasonList.Name = "dgResignationReasonList";
   this.dgResignationReasonList.ReadOnly = true;
   this.dgResignationReasonList.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
   this.dgResignationReasonList.RowHeadersWidth = 20;
   this.dgResignationReasonList.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
   this.dgResignationReasonList.Size = new System.Drawing.Size(1061, 498);
   this.dgResignationReasonList.TabIndex = 8;
   this.dgResignationReasonList.VirtualMode = true;
   this.dgResignationReasonList.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgResignationReasonList_CellDoubleClick);
   // 
   // colResignationReasonCode
   // 
   this.colResignationReasonCode.Frozen = true;
   this.colResignationReasonCode.HeaderText = "Code";
   this.colResignationReasonCode.Name = "colResignationReasonCode";
   this.colResignationReasonCode.ReadOnly = true;
   this.colResignationReasonCode.Width = 80;
   // 
   // colName
   // 
   ...
   this.colName.HeaderText = "Resignation Reason";
   ...
   this.Name = "frmResignationReasonList";
   this.Text = "Resignation Reason Master List";
   this.Load += new System.EventHandler(this.frmResignationReasonList_Load);
   this.pnlHeader.ResumeLayout(false);
   this.pnlHeader.PerformLayout();
   this.tsButtons.ResumeLayout(false);
   this.tsButtons.PerformLayout();
   this.pnlBody.ResumeLayout(false);
   ((System.ComponentModel.ISupportInitialize)(this.dgResignationReasonList)).EndInit();
  ...
  internal System.Windows.Forms.DataGridView dgResignationReasonList;
  private System.Windows.Forms.DataGridViewTextBoxColumn colResignationReasonCode;
