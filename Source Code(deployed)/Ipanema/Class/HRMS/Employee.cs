...
namespace HRMS
{
 ...
 public class Employee : IDisposable
 {
  ...
  public int Insert()
  {
   ...
   {
    SqlCommand cmd = cn.CreateCommand();
    cmd.CommandText = "INSERT INTO HR.Employees(username,empnum,lastname,firname,midname,midintl,nickname,brthdate,gender,etypcode,esttcode,comcode,position,cstatus,emailofc,schdcode,divicode,grpcode,deptcode,rccode,jgcode,assgnmnt,datestrt,datereg,updateby,updateon,pstatus,billable,rsrccode,rsrcrmks) VALUES(@username,@empnum,@lastname,@firname,@midname,@midintl,@nickname,@brthdate,@gender,@etypcode,@esttcode,@comcode,@position,@cstatus,@emailofc,@schdcode,@divicode,@grpcode,@deptcode,@rccode,@jgcode,@assgnmnt,@datestrt,@datereg,@updateby,@updateon,@pstatus,@billable,@rsrccode,@rsrcrmks)";
    cmd.Parameters.Add(new SqlParameter("@username", _strUsername));
